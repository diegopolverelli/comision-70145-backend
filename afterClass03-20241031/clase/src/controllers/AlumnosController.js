...
import { alumnosService } from "../repository/Alumnos.service.js"

export class AlumnosController{
    static getAlumnos=async(req,res)=>{
        try {
            // let alumnos=await AlumnosManager.getAlumnos()  
            let alumnos=await alumnosService.getAlumnos()
    ...
    static getAlumnoById=async (req, res) => {
        let { aid } = req.params
    ...
    static createAlumno=async (req, res) => {
        ...
        try {
            ...
            let nuevoUsuario = await alumnosService.createAlumno({ nombre, email })
            res.setHeader('Content-Type', 'application/json');
    ...
    static inscribirCurso=async (req, res) => {
    ...
    static cargarCursosAlumno=async (req, res) => {
        let { aid } = req.params
        if (!isValidObjectId(aid)) {
            res.setHeader('Content-Type', 'application/json');
